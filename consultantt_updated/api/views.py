...
def order_create(request):
    ...
    payment_method = body.get('payment_method', Order.PAYMENT_KASPI)
    ...
    if payment_method not in [Order.PAYMENT_KASPI, Order.PAYMENT_BANK]:
        return JsonResponse({'error': 'Неверный способ оплаты.'}, status=400)
